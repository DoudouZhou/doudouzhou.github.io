...
1. Lv, L., **Zhou, D.<sup>#</sup>** _Preference-based Centrality and Ranking in
...
1. **Zhou, D.**, Chen, H.  [_A New ranking Scheme for Modern Data and Its Application to Two-sample Hypothesis Testing._](https://proceedings.mlr.press/v195/zhou23a/zhou23a.pdf) Conference on Learning Theory (COLT), 2023. [[R package](https://cran.r-project.org/web/packages/GraphRankTest/index.html)]
