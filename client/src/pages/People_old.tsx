...
export default function People() {
  ...
  const visitors = [
    { name: "Lingfeng Lv", period: "2026--", institution: "University of Science and Technology of China", type: "Visiting PhD Student" },
    { name: "Huichao Li", period: "2025--", institution: "University of Chinese Academy of Sciences", type: "Visiting PhD Student" },
    { name: "Ruolin Ding", period: "2025--", institution: "University of Science and Technology of China", type: "Visiting PhD Student" },
    { name: "Yaya Zhao", period: "2025--", institution: "Renmin University of China", type: "Visiting PhD Student" }
  ];
            ...
            {visitors.map((visitor, index) => (
              <Card key={index} className="p-6 hover-lift">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-1">{visitor.name}</h3>
                    <p className="text-sm text-muted-foreground mb-2">{visitor.institution}</p>
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="outline">{visitor.period}</Badge>
                      <Badge variant="secondary">{visitor.type}</Badge>
                    </div>
                  </div>
                </div>
              </Card>
